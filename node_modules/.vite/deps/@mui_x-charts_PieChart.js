import {
  ...
  useTicks,
  warnOnce
} from "./chunk-J62IHG4A.js";
import {
  useThemeProps
} from "./chunk-UIKFOEV6.js";
import {
  Typography_default
} from "./chunk-456EQU2R.js";
import {
...
import "./chunk-ATYCQO2B.js";
import "./chunk-FN2NGOXC.js";
import {
  useTheme
} from "./chunk-KQKOUTNE.js";
import {
  useDefaultProps
} from "./chunk-H4Z6QFOM.js";
import {
  HTMLElementType,
  chainPropTypes,
  composeClasses,
...
var HighlightedContext = React7.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const seriesById = React8.useMemo(() => {
  ...
  const providerValue = React8.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React9.useContext(HighlightedContext);
  if (!isInitialized) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React10.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React10.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React11.useRef(null);
...
var AnimationContext = React12.createContext({
  isInitialized: false,
  data: {
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React13.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React14.createElement(Provider, { value: props }, children);
};
...
function AnimationProvider(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React16.useContext(AnimationContext);
  if (!isInitialized) {
...
var ChartContainer = React17.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime8.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime8.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime8.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
            ...
            children: (0, import_jsx_runtime8.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime8.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime8.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime8.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime8.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  ...
  const computeSize = React18.useCallback(() => {
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime12.jsxs)(YAxisRoot, {
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(React29.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React30.useState(null);
  React30.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React34.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React34.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React39.useMemo(
  ...
  const padding = React39.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React39.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React39.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React39.useMemo(() => {
...
function PieArc(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(PieArcRoot, _extends({
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime31.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index) => {
      ...
      return (0, import_jsx_runtime31.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime33.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime33.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
  ...
  return (0, import_jsx_runtime34.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime34.jsx)("g", {
        ...
        children: (0, import_jsx_runtime34.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime34.jsx)("g", {
        transform: `translate(${left2 + cx}, ${top2 + cy})`,
        children: (0, import_jsx_runtime34.jsx)(PieArcLabelPlot, {
          innerRadius,
...
var PieChart = React56.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
  ...
  return (0, import_jsx_runtime38.jsxs)(ResponsiveChartContainer, _extends({}, other, {
    ref,
    ...
    className,
    skipAnimation: skipAnimation2,
    children: [(0, import_jsx_runtime38.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime38.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick
    }), (0, import_jsx_runtime38.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
    }), (0, import_jsx_runtime38.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime38.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime38.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  }));
...
true ? PieChart.propTypes = {
  ...
  legend: import_prop_types26.default.shape({
    ...
    itemGap: import_prop_types26.default.number,
    itemMarkHeight: import_prop_types26.default.number,
    itemMarkWidth: import_prop_types26.default.number,
    labelStyle: import_prop_types26.default.object,
    markGap: import_prop_types26.default.number,
    onItemClick: import_prop_types26.default.func,
    padding: import_prop_types26.default.oneOfType([import_prop_types26.default.number, import_prop_types26.default.shape({
