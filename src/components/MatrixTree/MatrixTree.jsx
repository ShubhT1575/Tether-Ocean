  ...
  const fetchBlockData = async (address, slot, cycle) => {
    try {
      ...
      if (response.data && response.data.mergedRecords) {
        const OriginalData = response.data.mergedRecords.map((item) => item);
                        ...
                        <div className="mgt-item">
                          <div className="mgt-item-parent">
                            <div
                              className="person"
                              onClick={() =>
                                handleClick(place1?.user, place1?.userId)
                              }
                            >
                              <div className="person-profile"></div>
                              ...
                              <div className="mgt-item">
                                <div className="mgt-item-parent">
                                  <div
                                    className="person"
                                    onClick={() =>
                                      handleClick(place3?.user, place3?.userId)
                                    }
                                  >
                                    <div className="person-profile"></div>
                                    <p className="name">
                              ...
                              <div className="mgt-item">
                                <div className="mgt-item-parent">
                                  <div
                                    className="person"
                                    onClick={() =>
                                      handleClick(place4?.user, place4?.userId)
                                    }
                                  >
                                    <div className="person-profile"></div>
                                    <p className="name">
                        ...
                        <div className="mgt-item">
                          <div className="mgt-item-parent">
                            <div
                              className="person"
                              onClick={() =>
                                handleClick(place2?.user, place2?.userId)
                              }
                            >
                              <div className="person-profile"></div>
                              ...
                              <div className="mgt-item">
                                <div className="mgt-item-parent">
                                  <div
                                    className="person"
                                    onClick={() =>
                                      handleClick(place5?.user, place5?.userId)
                                    }
                                  >
                                    <div className="person-profile"></div>
                                    <p className="name">
                              ...
                              <div className="mgt-item">
                                <div className="mgt-item-parent">
                                  <div
                                    className="person"
                                    onClick={() =>
                                      handleClick(place6?.user, place6?.userId)
                                    }
                                  >
                                    <div className="person-profile"></div>
                                    <p className="name">
